...
class ImplementAlgorithm(MLAlgorithmAbstract):
    def createAndUseModel(self, filePath, yColumn, xColumnNumerical=[], xColumnCategorical=[]):
        ...
        if accuracy > 0.8:
            ModelSerialization.saveModel(self, classifier, '../inputFiles/DecisionTreeClassifier.pkl')
            ModelDeserialization.loadModel(self, '../inputFiles/DecisionTreeClassifier.pkl', yColumn, result[1])
